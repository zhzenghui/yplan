...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { autoload: @option.autoload, blog_id: @option.blog_id, option_id: @option.option_id, option_name: @option.option_name, option_value: @option.option_value }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { autoload: @option.autoload, blog_id: @option.blog_id, option_id: @option.option_id, option_name: @option.option_name, option_value: @option.option_value }
    assert_redirected_to option_path(assigns(:option))
  end
