...
class TermsControllerTest < ActionController::TestCase
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post :create, term: { name: @term.name, slug: @term.slug, term_group: @term.term_group, term_id: @term.term_id }
    end
  ...
  test "should update term" do
    patch :update, id: @term, term: { name: @term.name, slug: @term.slug, term_group: @term.term_group, term_id: @term.term_id }
    assert_redirected_to term_path(assigns(:term))
  end
